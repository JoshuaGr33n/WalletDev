        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span class="tools pull-right">
                    <a href="{{ route('subcategory.create') }}" data-toggle="tooltip" title="Add" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Add New">
...
$(document).ready(function(){
    ...
    var table = $('#dynamic-table').DataTable({
        ...
        $('.deletesubcategory').on('click',function(){
            var x = confirm("Do you want to delete the Sub Category?");
            if(x == true) { 
             var categoryid = $(this).data('subcategory'); 
                $.ajax({
