    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <form class="form-horizontal" autocomplete="off" role="form" method="POST" action="{{ route('subcategory.store') }}">
                 @csrf
                <div class="form-group @error('sub_category_name') has-error @enderror">
                    <label for="sub_category_name" class="col-lg-4 col-sm-4 control-label">Sub Category Name <span class="text-danger">*</span></label>
                    <div class="col-lg-8">
