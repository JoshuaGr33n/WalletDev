    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <form class="form-horizontal" autocomplete="off" role="form" method="POST" action="{{ route('vouchertype.update',['area' => $voucherTypeInfo->id ]) }}">
                 @csrf
                 {{method_field('PUT')}}   
                <div class="form-group @error('type_name') has-error @enderror">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" name="type_name" value="{{ $voucherTypeInfo->type_name }}" id="type_name" maxlength="20" placeholder="Type Name">
                ...
                <div class="form-group @error('type_id') has-error @enderror">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control nospace" name="type_id" value="{{ $voucherTypeInfo->type_id }}" id="type_id" maxlength="10" placeholder="Type ID">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        {!! Form::select('status', $status, $voucherTypeInfo->status, ['class' => 'form-control m-bot15']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <button type="submit" class="btn btn-primary">Update Voucher Type</button>
