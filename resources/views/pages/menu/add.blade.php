    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <form class="form-horizontal" autocomplete="off" role="form" enctype="multipart/form-data" method="POST" action="{{ route('menu.store') }}">
                 @csrf
                ...
                <div class="form-group @error('item_best_price') has-error @enderror">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="item_best_price" id="item_best_price" placeholder="Item Best Price">
                ...
                <div class="form-group @error('upc_code') has-error @enderror">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control" name="upc_code" id="upc_code" placeholder="UPC Code">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <textarea rows="3" id="item_description" name="item_description" class="form-control" placeholder="Description"></textarea>
                  </div>
                </div>
                <div class="form-group">
