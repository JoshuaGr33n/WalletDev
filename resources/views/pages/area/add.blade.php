    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="position-center">
                <form class="form-horizontal" autocomplete="off" role="form" method="POST" action="{{ route('area.store') }}">
                 @csrf
                <div class="form-group @error('area_name') has-error @enderror">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" name="area_name" id="inputEmail1" placeholder="Area Name">
                ...
                <div class="form-group @error('pincode') has-error @enderror">
                    ...
                    <div class="col-lg-10">
                        <input type="text" class="form-control" name="pincode" id="inputPassword1" placeholder="Pincode">
