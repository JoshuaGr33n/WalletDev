        ...
        <section class="panel">
            <header class="panel-heading">
                ...
                <span class="tools pull-right">
                    <a href="{{ route('outlet.create',['merchant_id'=>$merchant_id]) }}" data-toggle="tooltip" title="Add" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Add New">
...
$(document).ready(function(){
    ...
    var table = $('#dynamic-table').DataTable({
        ...
        columns: [
            ...
            {data: 'outlet_hours', name: 'outlet_hours'},
            {data: 'outlet_email', name: 'outlet_email'},
        ...
        $('.deleteOutlet').on('click',function(){
            var x = confirm("Do you want to delete the outlet?");
            if(x == true) { 
             var outletid = $(this).data('outlet'); 
                $.ajax({
                    url: "{{ route('deleteOutlet') }}",
                    data: { "id": outletid,"merchant_id": {{$merchant_id}} },
                    type: "post",
                    dataType: "json",
