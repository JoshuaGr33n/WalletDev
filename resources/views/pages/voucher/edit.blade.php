                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="total_required_points" id="total_required_points" value="{{ $voucherInfo->total_required_points }}" class="form-control number"  placeholder="Total Required Points">
                        </div>
                      </div>
...
$(".select2, .select2-multiple").select2({placeholder:"-- Select Outlet --"});
$(document).ready(function(){
