    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="box box-primary">
                <form class="form-horizontal" autocomplete="off" role="form" enctype="multipart/form-data" method="POST" action="{{ route('bundle-vouchers.store') }}">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group @error('bundle_voucher_name') has-error @enderror">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="bundle_voucher_name" id="bundle_voucher_name" value="{{old('bundle_voucher_name')}}" placeholder="Bundle Voucher Name">
                                        ...
                                        <select name="vouchers[]" multiple="multiple" class="3col active form-control">
                                            @foreach($voucherLists as $voucher)
                                               @if($voucher->free_voucher_type == "birthday")
                                                <option value="{{$voucher->id}}">{{$voucher->voucher_name}}(B)</option>
                                                @elseif($voucher->free_voucher_type == "welcome")
                                                <option value="{{$voucher->id}}">{{$voucher->voucher_name}}(W)</option>
                                                @else
                                ...
                                <div class="form-group">
                                    <label for="bundle_voucher_image" class="col-md-4 control-label">Voucher Logo</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-6">
                                <div class="form-group @error('buy_bundle_voucher_with_wallet_credits_value') has-error @enderror">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="buy_bundle_voucher_with_wallet_credits_value" id="buy_bundle_voucher_with_wallet_credits_value" class="form-control number" value="{{old('buy_bundle_voucher_with_wallet_credits_value')}}" placeholder="Total Required Wallet Credit">
                                    </div>
                                </div>
                                ...
                                <div class="form-group @error('bundle_voucher_description') has-error @enderror">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="wysihtml5 form-control" name="bundle_voucher_description" id="bundle_voucher_description" rows="5">{{old('bundle_voucher_description')}}</textarea>
                                ...
                                <div class="form-group" id="free_points">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="free_points_value" id="free_points_value" class="form-control number" value="{{old('free_points_value')}}" placeholder="Free Points">
                                    </div>
                                </div>
                                <div class="form-group">
